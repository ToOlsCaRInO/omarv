...
def boten(message):
    ...
    M = types.InlineKeyboardButton('المطور', url='https://t.me/CCCCCC4CCC')
...
def masg(call):
	...
	if call.data = "UUU0Uc":
		...
		M = types.InlineKeyboardButton('المطور', url='https://t.me/ToOlsCaRiNo')
...
if __name__ == "__main__":
    bot.remove_webhook()
    bot.set_webhook(url="https://naw4.herokuapp.com/"+str(BOT_TOKEN))
